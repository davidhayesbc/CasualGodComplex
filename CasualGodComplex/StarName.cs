...
public static class StarName
{
    ...
    private static readonly HashSet<string> FictionalLocations = new()
    {
        // Dune (Stars)
        ...
        "Pendari", "Pentath", "Pernaia", "Phylos", "Portas", "Prema", "Procyon", "Questar", "Ramatis", "Regulus", "Rigel", "Romii", "Ross 154", "Rubicun", "Sahndara", "Sappora",
        "Sarona",
        "Sarpeid", "Secarus", "Shelia", "Sheliak", "Draconis", "Nesterowitz", "Sirius", "Sol", "Solais", "Solarion", "Soukara", "Stillwell", "Strnad", "Tambor Beta-6", "Talos",
        "Tanuga",
    ...
    private static readonly HashSet<string> GreekLetters = new()
    {
        "Alpha", "Beta", "Gamma", "Delta", "Epsilon", "Zeta", "Eta", "Theta", "Iota", "Kappa", "Lambda", "Mu", "Nu", "Xi", "Omnicron", "Pi", "Rho",
        "Sigma", "Tau", "Upsilon", "Phi", "Chi", "Psi", "Omega"
    };

    private static readonly HashSet<string> Decorators = new()
    {
        "Major", "Majoris", "Minor", "Minoris", "Prime", "Secundis", "System"
    };

    private static readonly HashSet<string> SpecialLocations = new()
    {
    ...
    private static readonly StrategyList _namingStrategies = new()
    {
    ...
    private static readonly StrategyList _prefixStrategies = new()
    {
        Weighted(1.0f, Greek),
    ...
    private static readonly StrategyList _suffixStrategies = new()
    {
        Weighted(1.0f, Greek),
        Weighted(1.0f, Decorator),
    ...
    {
        var integer = (int)random.NormallyDistributedSingle(10, 15, 1, 200);
        var bigInteger = (int)random.NormallyDistributedSingle(400, 100, 200, 3000);
